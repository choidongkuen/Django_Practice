...
urlpatterns = [
    ...
    path("comment/update/question/<int:comment_id>/", views.comment_update_question, name="comment_update_question"),
    ...
    path("comment/update/answer/<int:comment_id>/", views.comment_update_answer, name="comment_update_answer"),
